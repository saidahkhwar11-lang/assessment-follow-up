        ...
        const renderAttainmentParent = (rows: Array<{studentId:string;name:string;value:number}>, label: string) => {
          ...
          result.innerHTML =
            ...
            (() => {
              ...
              return '<section class="card"><h2>3. Student Groups Requiring Action</h2><p><b>Plan generated for:</b> ' + safe(skill) + ' — ' + safe(p.focus) + '.</p><table><thead><tr><th>Group</th><th>Students</th><th>Specific response</th><th>Measurement</th></tr></thead><tbody>' +
                ...
                '<section class="card"><h2>4. SMART Improvement Target</h2><p class="analysis"><b>Class target:</b> ' + targetText + '</p><p><b>' + safe(skill) + ' intervention target:</b> ' + safe(p.target) + '</p></section>' +
                '<section class="card"><h2>5. Teaching & Intervention Action Plan — ' + safe(skill) + '</h2><table><thead><tr><th>When</th><th>Action</th><th>Who</th><th>Measure</th><th>Decision</th></tr></thead><tbody>' +
